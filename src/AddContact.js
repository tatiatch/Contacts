    ...
    render(){
        return <div className = "container filter-form">
            ...
            <form>
                ...
                <button type="button" className="btn btn-primary mr-1" onClick={this.save}>დამატება</button>
                <button type="button" className="btn btn-secondary" onClick={()=>this.props.close()} >დახურვა</button>
            </form>
        </div>
    }
}
